#!/usr/bin/env bash
# forge.sh — forge-agnostic CLI adapter for the prmonitor PR / issue automation.
#
...
#   PRMONITOR_FORGE=github forge.sh pr-refs 42
#
...
# their value.
#
# Active forge: PRMONITOR_FORGE env > forge.conf DEFAULT_FORGE.
#
...
FORGE="${PRMONITOR_FORGE:-${DEFAULT_FORGE:-github}}"
case "${FORGE}" in
...
Active forge from PRMONITOR_FORGE env or forge.conf DEFAULT_FORGE.
EOF
}
