...
# Funnel strength (honest, per .claude/rules/prmonitor/ai-robust.md): overall Medium.
# Downstream logic Medium (single decision point; selftest is the golden gate;
# not compile-time un-expressible, so not Hard). Upstream
...
_VALID_AREAS="area-config area-pr area-review area-dispatch area-data area-ui area-tooling area-cross"
