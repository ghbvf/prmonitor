...
// AzStatus is slice-private (mirrors the `az_status` command's Rust return shape,
// serde camelCase); like GhStatus it is not a cross-slice contract, so it lives here.
