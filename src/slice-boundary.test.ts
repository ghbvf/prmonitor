...
//
// The vertical slices (config / pr / review / inbox / outbox / terminal / messaging) must be
...
const SLICES = ["config", "pr", "review", "inbox", "outbox", "terminal", "messaging"] as const;
...
const sources = import.meta.glob("./{config,pr,review,inbox,outbox,terminal,messaging}/**/*.{ts,vue}", {
  query: "?raw",
  import: "default",
  eager: true,
