...
export type CliTool = "gh" | "az" | "codex" | "claude" | "agent" | "cloudflared";
export const CLI_TOOLS = ["gh","az","codex","claude","agent","cloudflared"] as const;
...
export type EngineKind = "codex" | "claude" | "cursor";
export const ENGINE_KINDS = ["codex","claude","cursor"] as const;
